...
// GET: Show login form (or redirect to login page)
export async function GET(request: NextRequest) {
  ...
  // Check client exists or auto-register for allowed domains
  ...
  if (!registeredUris.includes(redirectUri)) {
    // For auto-registered clients, add the redirect URI
    if (isAllowedAutoRegisterDomain(redirectUri)) {
      // Already registered with this URI during auto-register
    } else {
