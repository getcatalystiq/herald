#!/bin/bash
#
# Deploy Herald Admin UI to S3 + CloudFront
#
# Usage:
...
echo -e "${GREEN}╔════════════════════════════════════════════════════════════╗${NC}"
echo -e "${GREEN}║           Herald Admin UI - Deployment                     ║${NC}"
echo -e "${GREEN}╚════════════════════════════════════════════════════════════╝${NC}"
echo ""
...
if [ -z "$S3_BUCKET" ]; then
    ...
    echo "Make sure the Herald backend is deployed: cd .. && ./scripts/deploy.sh ${ENVIRONMENT}"
    exit 1
fi
...
echo "  ${API_URL}"
echo ""
echo -e "${YELLOW}MCP Server URL (for Claude):${NC}"
echo "  ${API_URL}/mcp"
echo ""
