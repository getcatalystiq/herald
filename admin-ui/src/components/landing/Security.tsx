...
const securityFeatures = [
  ...
  },
  {
    ...
    description: 'Temporary credentials via STS AssumeRole. No long-lived keys stored.',
  },
  {
    icon: Users,
    title: 'Per-User Access',
    description: 'Fine-grained permissions per user with optional prefix restrictions.',
  },
  {
    icon: Lock,
    title: 'Encrypted Storage',
    description: 'Role ARNs stored in AWS Secrets Manager. TLS everywhere.',
  },
  {
    icon: Eye,
    title: 'Audit Logging',
    description: 'Every upload logged with user, timestamp, file details, and metadata.',
  },
  {
    icon: FileCheck,
    title: 'File Validation',
    description: 'Content type detection, size limits, and configurable restrictions.',
  },
];
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-gray-400 leading-relaxed">
            Your S3 credentials and data are protected by multiple layers of security.
            We use temporary credentials and never store long-lived access keys.
          </p>
        </div>
