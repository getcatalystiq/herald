...
const steps = [
  {
    number: 1,
    title: 'Connect',
    description: 'Add your S3 bucket credentials securely. We support cross-account access via IAM role assumption.',
    icon: Cloud,
  ...
  },
  {
    number: 2,
    title: 'Authorize',
    description: 'Grant users access to specific buckets with fine-grained permissions: read, write, or delete.',
    icon: Users,
  ...
  },
  {
    number: 3,
    title: 'Publish',
    description: 'AI agents can now publish files directly using MCP tools. Every upload is logged for audit.',
    icon: Upload,
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed">
            Three simple steps to enable AI agents to publish files to your S3 buckets.
          </p>
        </div>
                ...
                <div className="relative bg-card rounded-2xl border border-border p-6 h-full hover:shadow-lg hover:border-primary/20 transition-all duration-300">
                  ...
                  >
                    <Icon className={cn(
                      ...
                      step.number === 3 && 'text-green-600 dark:text-green-400'
                    )} />
                  </div>
