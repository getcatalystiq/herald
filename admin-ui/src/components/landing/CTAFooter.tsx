    ...
    <section className="py-24 bg-gradient-to-br from-primary via-primary to-orange-600 relative overflow-hidden">
      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 relative text-center">
        ...
        <p className="text-lg sm:text-xl text-white/80 max-w-2xl mx-auto mb-10 leading-relaxed animate-fade-in-up animation-delay-100">
          Deploy Herald to your AWS account. Connect your S3 bucket, grant access, and
          start publishing files with AI agents.
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in-up animation-delay-200">
          <Button
            ...
            asChild
          >
            <a href="https://github.com/getcatalystiq/herald#readme" target="_blank" rel="noopener noreferrer">
              View Documentation
          ...
          <Button
            ...
            asChild
          >
            <a href="https://github.com/getcatalystiq/herald" target="_blank" rel="noopener noreferrer">
              View on GitHub
            </a>
          </Button>
        </div>
