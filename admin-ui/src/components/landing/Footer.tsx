...
const footerLinks = {
  ...
  resources: [
    { label: 'Documentation', href: 'https://docs.herald.dev', external: true },
    { label: 'API Reference', href: 'https://docs.herald.dev/api', external: true },
    { label: 'GitHub', href: 'https://github.com/herald-dev', external: true },
  ],
  company: [
    { label: 'About', href: '#' },
    { label: 'Contact', href: 'mailto:hello@herald.dev' },
  ],
  legal: [
    { label: 'Privacy', href: '#' },
    { label: 'Terms', href: '#' },
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-6 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-gray-500">
            &copy; {currentYear} Herald. All rights reserved.
          </p>

          {/* Social links */}
          <div className="flex items-center gap-4">
            <a
              href="https://github.com/herald-dev"
              target="_blank"
              rel="noopener noreferrer"
