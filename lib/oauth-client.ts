...
/**
 * OAuth 2.1 with PKCE client-side implementation for Herald Admin UI.
 * Adapted from admin-ui/src/auth/oauth.ts for Next.js (same-origin API).
 */
...
const STORAGE_KEYS = {
  ACCESS_TOKEN: "herald_access_token",
  REFRESH_TOKEN: "herald_refresh_token",
  TOKEN_EXPIRY: "herald_token_expiry",
  CODE_VERIFIER: "herald_code_verifier",
  CLIENT_ID: "herald_client_id",
  CLIENT_SECRET: "herald_client_secret",
  USER_INFO: "herald_user_info",
};
