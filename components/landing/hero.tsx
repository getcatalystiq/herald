        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div className="text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start animate-fade-in-up animation-delay-200">
              <Button
                size="lg"
                className="text-base px-8 py-6 shadow-lg shadow-primary/20 hover:shadow-primary/30 transition-shadow"
                asChild
              >
                <a
                  href="https://github.com/nichochar/herald#readme"
                  target="_blank"
              ...
              <Button
                size="lg"
                variant="outline"
                className="text-base px-8 py-6 border-white/40 bg-white/10 text-white hover:bg-white/20 hover:text-white hover:border-white/60"
                asChild
              >
                <a
                  href="https://github.com/nichochar/herald"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  View on GitHub
          ...
          <div className="relative animate-fade-in-up animation-delay-200">
            ...
            <div className="relative bg-gray-900/80 backdrop-blur-sm rounded-2xl border border-white/10 shadow-2xl overflow-hidden">
              ...
              <div className="px-4 py-2 border-t border-white/5 bg-gray-900/50 flex items-center justify-between">
                <span className="text-xs text-gray-500">Vercel Blob</span>
