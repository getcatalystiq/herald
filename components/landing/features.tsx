...
const features: Feature[] = [
  ...
  },
  {
    id: "multi",
    title: "Multi-Bucket",
    description: "Connect and manage multiple storage buckets.",
    icon: Database,
    size: "small",
  ...
  return (
    ...
    >
      ...
      <div className="relative">
        ...
        >
          <Icon
            className={cn(feature.size === "large" ? "h-6 w-6" : "h-5 w-5")}
          />
        </div>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed">
            Everything you need to publish files with AI agents. From direct
            uploads to file management, all accessible through the Model Context
            Protocol.
          </p>
        </div>
